...
variant: tiptap
description: GovTech develops Tech for Public Good such as TraceTogether,
  SafeEntry, the GoWhere Suite and the government Video Analytics System. Learn
  more!
...
<h3>Easy communications with the government</h3>
...
<h3>How we empower vulnerable communities with tech</h3>
<div class="isomer-image-wrapper">
<img style="width: 100%" height="auto" width="100%" alt="" src="/images/Digital Gov Efforts/Empowering_vulnerable_communities_through_tech.jpg">
</div>
<p>Through the Smart Nation initiative, we aim to use technology to build
an inclusive society for all citizens and enhance the well-being of vulnerable
...
<p>A contact tracing technology that utilises Bluetooth, TraceTogether allows
a log of individuals that one has been in close contact. It also worked
with SafeEntry, to facilitate tracking and check-ins at public spaces.
...
<p>This consists of the GoWhere Directory, a one-stop national resource hub
for citizens to access all official COVID-19 related information and government
guides efficiently and quickly, and location query-based websites that
have helped facilitate nation-wide distribution exercises. Even though
...
snapshots captured by CCTV cameras in parks, at regular intervals, to VAS.</p>
<p>It is an award-winning smart city operating system that integrates various
district management operations onto a single platform, such as facilities,
district cooling systems, security systems, carpark systems and more. an
award-winning smart city operating system that integrates various district
management operations onto a single platform, such as facilities, district
cooling systems, security systems, carpark systems and more.</p>