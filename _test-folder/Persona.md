...
<style>
    ...
    .persona-template .section {
        width: 100%;
        position: relative;
        margin-bottom: 44px
    }

    .persona-template .section.linebreak {
        width: 100%;
        height: 1px;
    ...
    .persona-template .banner-image {
        width: 100%;
        height: auto;
    }

    .persona-template .section.card-banner-container,
    .persona-template .section.card-banner-container-three  {
        display: flex;
        flex-wrap: wrap;
    }

    .persona-template .card-banner-box {
        flex: 0 0 50%;
        position: relative;
    }

    .persona-template .section.card-banner-container-three .card-banner-box {
        flex: 0 0 33%;
    }

    .persona-template .card-banner-image {
        width: calc(100% - 12px);
    ...
    .persona-template .card-banner-box:nth-of-type(odd) .card-banner-image {
        margin-right: 12px;
    }

    .persona-template .card-banner-box:nth-of-type(even) .card-banner-image {
        margin-left: 12px;
    }

    .persona-template .section.card-banner-container-three .card-banner-image {
        width: calc(100% - 16px);
    }

    .persona-template .section.card-banner-container-three .card-banner-box:nth-of-type(3n-2) .card-banner-image {
        margin-right: 16px;
    }

    .persona-template .section.card-banner-container-three .card-banner-box:nth-of-type(3n-1) .card-banner-image {
        margin-right: 8px;
        margin-left: 8px;
    }

    .persona-template .section.card-banner-container-three .card-banner-box:nth-of-type(3n-0) .card-banner-image {
        margin-left: 16px;
    }

    .persona-template .card-banner-image h3,
    .persona-template .card-banner-image h5 {
        margin-bottom: 15px
    }

    .persona-template .section.swap-image-container {
        display: flex;
        flex-direction: column;
    }

    .persona-template .swap-image-box {
        display: flex;
        flex-direction: row;
        margin-bottom: 44px;
    }

    .persona-template .swap-image-box:last-of-type {
        margin-bottom: 0px;
    }

    .persona-template .swap-image-box:nth-of-type(even) {
        flex-direction: row-reverse;
    }

    .persona-template .swap-image-box > img {
        width: 294px;
        height: 221px;
        border-radius: 10px
    }

    .persona-template .swap-image-box > .swap-image-details {
    ...
    .persona-template .swap-image-box:nth-of-type(even) > .swap-image-details {
        padding-left: 0px;
        padding-right: 26px;
    }

    .persona-template .swap-image-details > h4 {
        margin-bottom: 30px
    }

    .persona-template .section.swap-banner-container {
        display: flex;
        flex-direction: column;
    }

    .persona-template .swap-banner-box {
        display: flex;
        flex-direction: row;
        margin-bottom: 44px;
        background-position: center;
    ...
    .persona-template .swap-banner-box:last-of-type {
        margin-bottom: 0px;
    }

    .persona-template .swap-banner-box:nth-of-type(even) {
        flex-direction: row-reverse;
    }

    .persona-template .swap-banner-box > .swap-banner-details {
        width: 55%;
        height: 300px;
        box-sizing: border-box;
        padding-left: 26px;
    ...
    .persona-template .swap-banner-box:nth-of-type(even) > .swap-banner-details {
        padding-left: 0px;
        padding-right: 26px;
    }

    .persona-template .swap-banner-details > h3 {
        margin-bottom: 30px
    }

    .persona-template .swap-banner-details > .body-text-small {
        margin-bottom: 30px
    }

    .persona-template .section.info-cards-container {
        display: flex;
        flex-wrap: wrap;
    }

    .persona-template .info-cards {
        flex: 0 0 33.33333%;
        box-sizing: border-box;
    }

    .persona-template .info-cards:nth-of-type(3n+1) {
        padding-right: 16px;
    }

    .persona-template .info-cards:nth-of-type(3n+2) {
        padding-right: 8px;
        padding-left: 8px;
    }

    .persona-template .info-cards:nth-of-type(3n+3) {
        padding-left: 16px;
    }

    .persona-template .info-cards > img {
        width: 100%;
        height: auto;
        float: left;
        display: block;
    ...
    .persona-template .info-cards-details {
        width: 100%;
        height: auto;
        float: left;
        display: block;
    ...
    .persona-template .info-cards-details.no-image {
        border-top: 2px solid #D9D9D9;
        border-top-right-radius: 10px;
        border-top-left-radius: 10px;
    }

    .persona-template .portrait-box > img {
        width: 246px;
        height: 246px;
        border-radius: 10px;
        float: left;
    ...
    .persona-template .portrait-box-details {
    ...
    .persona-template .portrait-box-details > h4 {
        margin-bottom: 11px
    }

    .persona-template .quote-box > .body-text-small {
        margin-top: 11px;
        text-align: right;
    }

    .persona-template .accordion-container {
        border-bottom: 1px solid #8A8A8A;
    }

    .persona-template .accordion-container input {
        display: none;
    }

    .persona-template .accordion-container label {
        display: flex;
        padding: 11px 15px;
        margin: 0 0 5px 0;
        cursor: pointer;
    ...
    .persona-template .accordion-container label h5 {
        color: #484848 !important; 
    }

    .persona-template .accordion-container label .open-accordion-icon {
        display: block;
    }

    .persona-template .accordion-container label .close-accordion-icon {
        display: none;
    }

    .persona-template .accordion-container .accordion-content {
        padding: 10px 0px 30px 30px;
        margin: 0 0 1px 0;
        border-radius: 3px;
    }

    .persona-template .accordion-container input:checked + label h5 {
        color: #4372D6 !important;
    }

    .persona-template .accordion-container input:checked + label .open-accordion-icon {
        display: none;
    }

    .persona-template .accordion-container input:checked + label .close-accordion-icon {
        display: block;
    }

    .persona-template .accordion-container input + label + .accordion-content {
        display: none;
    }

    .persona-template .accordion-container input:checked + label + .accordion-content {
        display: flex;
    }

    .persona-template .feature-image {
        width: 100%;
        height: auto;
        display: flex;
        flex-direction: column;
    ...
    .persona-template .feature-image > img {
        width: 500px;
        height: 375px;
        margin-bottom: 20px;
        border-radius: 10px
    ...
    .persona-template .feature-image-button-holder {
        width: 100%;
        display: flex;
        justify-content: center;
    }

    .persona-template .feature-image-button-holder > .button-blue,
    .persona-template .feature-image-button-holder > .button-default {
        margin: 0px 10px
    }

    .persona-template .feature-image-text {
        margin-top: 20px
    }

    .persona-template .feature-center {
        text-align: center;
    }

    .persona-template .feature-center > h3 {
        margin-bottom: 30px
    }

    .persona-template .feature-center > .body-text-regular {
        margin-bottom: 30px
    }

    .persona-template .feature-center > img {
        margin-bottom: 30px;
        width: 412px;
        height: 232px;
        border-radius: 10px
    ...
    @media only screen and (max-width: 768px) {
        ...
        .persona-template .info-cards:last-of-type {
            padding-bottom: 0px;
        }
        ...
        .persona-template .info-cards-details .body-text-small {
            display: block;
            margin-top: 11px
        }
...
<div class="iso-template persona-template">
    <div class="section">
