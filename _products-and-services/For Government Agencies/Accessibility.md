---
title: Accessibility
permalink: /products-and-services/for-government-agencies/accessibility/
variant: tiptap
description: Purple A11y is an open-source tool that allows public service
  officers to increase the accessibility of their agencies' websites. Learn
  more.
third_nav_title: For Government Agencies
image: /images/Products and Services/Product overview card
  images/Accessibility_compressed.jpg
---
<h2>Purple A11y: Enabling the development of more inclusive government digital services</h2>
...
Purple A11y, an open-source, customisable and automated web accessibility
testing tool that allows software development teams to find and fix accessibility
problems.</p>
...
<p></p>
<div class="isomer-image-wrapper">
<img style="width: 100%" height="auto" width="100%" alt="Purple A11y will generate an accessibility site report that highlights bugs and suggests fixes." src="/images/Products and Services/For Government Agencies/Fig_1_Purple_HATS_Report_compressed.jpg">
</div>
<h3>Interested to find out more about Purple A11y?</h3>
<div class="isomer-card-grid"><a rel="noopener noreferrer nofollow" href="https://www.developer.tech.gov.sg/products/categories/design/purple-a11y/overview" class="isomer-card"><div class="isomer-card-image"><div class="isomer-image-wrapper"><img style="width: 100%" height="auto" width="100%" alt="Learn more about its features on the Singapore Government Developer Portal" src="/images/CTA card images/Visit_the_SGDP_Portal.png"></div></div><div class="isomer-card-body"><div class="isomer-card-title">Learn more about its features on the Singapore Government Developer Portal</div><div class="isomer-card-link">Learn more on SGDP</div></div></a>
